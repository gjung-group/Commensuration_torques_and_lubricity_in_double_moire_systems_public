...
name = "generateInitWithBN.xyz" # Upate with the correct initial position file, 3 first lines give the lattice vectors, fourth line gives the number of atoms and the next lines give the coordinates of the atoms in .xyz format.
...
name = "generateWithBN.xyz" # Update with the correct final position file after relaxation
